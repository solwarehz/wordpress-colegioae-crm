<?php
/**
 * home.php — Template para la página de blog (listado de posts).
 * Este template se usa automáticamente para la página configurada como
 * "Página de entradas" en WP Admin → Ajustes → Lectura.
 *
 * Comparte layout con archive.php (categoría/tag/fecha).
 */
...
<main id="main" class="site-main">
    <div class="container section">
        <header class="blog-archive__header">
            <h1 class="blog-archive__title"><?php esc_html_e('Blog', 'colegio-ae'); ?></h1>
                ...
                <?php if (!empty($cats)) : ?>
                    <div class="blog-archive__filter-group">
                        ...
                        <ul class="blog-archive__filter-list">
                            <li><a href="<?php echo esc_url(home_url('/blog/')); ?>" class="is-active"><?php esc_html_e('Todas', 'colegio-ae'); ?></a></li>
