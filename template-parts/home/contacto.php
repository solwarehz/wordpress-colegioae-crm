...
<section id="<?php echo esc_attr($anchor); ?>" class="section contacto" aria-labelledby="<?php echo esc_attr($anchor); ?>-title">
    <div class="container container--narrow">
        <header class="contacto__header">
            <h2 id="<?php echo esc_attr($anchor); ?>-title" class="contacto__title"><?php echo esc_html($title); ?></h2>
        ...
        <div class="contacto__form">
            ...
            $fallback = '<div class="contacto__notice">
                ...
                <p>Crea un formulario en <a href="https://tally.so" target="_blank" rel="noopener noreferrer">tally.so</a> (gratuito) con los campos <em>nombre</em>, <em>email</em>, <em>celular</em> y <em>mensaje</em>, copia el código embed y pégalo en el Customizer.</p>
            </div>';
